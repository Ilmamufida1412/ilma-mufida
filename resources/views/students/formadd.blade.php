        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-3">
                    <input type="text" name="txtage" id="txtage" class="form-control form-control-sm @error('txtage') is-invalid @enderror" value="{{ old('txtage') }}">
                    @error('txtage')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control  @error('txtaddress') is-invalid @enderror" name="txtaddress" id="txtaddress" cols="15" rows="5" value="{{ old('txtaddress') }}"></textarea>
                    @error('txtaddress')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" name="txtemail" id="txtemail" class="form-control form-control-sm @error('txtemail') is-invalid @enderror" value="{{ old('txtemail') }}">
                    @error('txtemail')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
