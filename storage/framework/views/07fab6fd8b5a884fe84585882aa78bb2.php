...
<h4>Form New Data Students</h4>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php echo csrf_field(); ?>
            <div class="row mb-3">
                <label for="txtid" class="col-sm-2 col-form-label col-form-label-sm">Id Students</label>
                <div class="col-sm-4">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('txtage')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="txtaddress" id="txtaddress" cols="15" rows="5" value="<?php echo e(old('txtaddress')); ?>"></textarea>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('txtemail')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('txtphone')); ?>">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app-laravel10\resources\views/students/formadd.blade.php ENDPATH**/ ?>